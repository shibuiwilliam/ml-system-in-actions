...
class ModelConfigurations:
    ...
    preprocess_transformer_path = os.getenv(
        "PREPROCESS_TRANSFORMER_PATH", "/data_cache_pattern/models/preprocess_transformer.pkl"
    )
    softmax_transformer_path = os.getenv(
        "SOFTMAX_TRANSFORMER_PATH", "/data_cache_pattern/models/softmax_transformer.pkl"
    )
