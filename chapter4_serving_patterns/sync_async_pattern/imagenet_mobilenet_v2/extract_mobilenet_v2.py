...
class MobilenetV2(tf.keras.Model):
    ...
    def save(self, export_path="./saved_model/mobilenet_v2/"):
...
def main():
    ...
    mobilenet_v2_hub_model = load_hub_model()
    mobilenet_v2_model = MobilenetV2(model=mobilenet_v2_hub_model, labels=labels)
    version_number = 0
    mobilenet_v2_model.save(export_path=f"./saved_model/mobilenet_v2/{version_number}")
