...
from src.app.ml.resnet50_onnx_server.proto import onnx_ml_pb2 as onnx__ml__pb2
...
_PREDICTREQUEST_INPUTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="onnxruntime.server.PredictRequest.InputsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="onnxruntime.server.PredictRequest.InputsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PREDICTREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="inputs",
            full_name="onnxruntime.server.PredictRequest.inputs",
            index=0,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="output_filter",
            full_name="onnxruntime.server.PredictRequest.output_filter",
            index=1,
            number=3,
            type=9,
            cpp_type=9,
...
_PREDICTRESPONSE_OUTPUTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="onnxruntime.server.PredictResponse.OutputsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="onnxruntime.server.PredictResponse.OutputsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PREDICTRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="outputs",
            full_name="onnxruntime.server.PredictResponse.outputs",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
