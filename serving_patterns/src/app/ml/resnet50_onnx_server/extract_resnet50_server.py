...
WORK_DIR = "./src/app/ml/resnet50_onnx_server/"
...
def main():
    modelname = "resnet50_onnx_server"
    ...
    save_interface(
        ...
        "float32",
        DATA_TYPE.IMAGE,
        [{preprocess_filepath: MODEL_RUNTIME.SKLEARN}, {MODEL_FILEPATH: MODEL_RUNTIME.ONNX_RUNTIME_SERVER}, {postprocess_filepath: MODEL_RUNTIME.SKLEARN}],
        PREDICTION_TYPE.CLASSIFICATION,
        "src.app.ml.resnet50_onnx_server.resnet50_server_predictor",
